(function () {
  ...
  var I18N = {
    en: {
      ...
      "launch.tag": "Admissions Open",
      "launch.h2": "Join our maths batches",
      "launch.p": 'Classes are underway at Bhasme Sir Coaching Center. Learn directly from an award-winning, 35-year-experienced teacher — limited seats for focused, personal attention.',
      "launch.cta": "Enquire Now",
      ...
      "ci.email": "Email",
      "ci.start": "Batches",
      "ci.startVal": "Running — admissions open",
      "ci.batches": "Batches",
    ...
    mr: {
      ...
      "launch.h2": "आमच्या गणित बॅचमध्ये सामील व्हा",
      "launch.p": 'भस्मे सर कोचिंग सेंटरमध्ये वर्ग सुरू आहेत. पुरस्कारप्राप्त, ३५ वर्षांचा अनुभव असलेल्या शिक्षकांकडून थेट शिका — मर्यादित जागा, वैयक्तिक लक्ष.',
      "launch.cta": "चौकशी करा",
