...
var I18N = {
  en: {
    ...
    "auth.loginHint": "Students: username = first initial + surname (e.g. jsahare) · password = 10-digit mobile (no +91). Legacy accounts may still use mobile as username.",
    "auth.adminHint": "Admins: use Continue with Google, or enter your full email in the field below with your admin password.",
    "auth.loginId": "Username, mobile, or email",
    ...
    "auth.forgotIntro": "Student login: username = first initial + surname (lowercase), password = 10-digit mobile. Older accounts may still use mobile as username. Contact admin if you cannot sign in.",
    ...
    "msg.loginIdInvalid": "Enter a valid username, 10-digit mobile number, or email address.",
  ...
  mr: {
    ...
    "auth.loginHint": "विद्यार्थी: username = पहिल्या नावाचा पहिला अक्षर + आडनाव (उदा. jsahare) · पासवर्ड = १० अंकी मोबाइल (+91 नको). जुन्या खात्यांसाठी मोबाइल username असू शकतो.",
    "auth.adminHint": "प्रशासक: Google ने सुरू ठेवा, किंवा खाली पूर्ण ईमेल + प्रशासक पासवर्ड टाका.",
    "auth.loginId": "Username, मोबाइल किंवा ईमेल",
    ...
    "auth.forgotIntro": "विद्यार्थी लॉगिन: username = पहिल्या नावाचा पहिला अक्षर + आडनाव, पासवर्ड = १० अंकी मोबाइल. जुन्या खात्यांसाठी मोबाइल username असू शकतो. लॉगिन होत नसेल तर प्रशासकाशी संपर्क करा.",
    ...
    "msg.loginIdInvalid": "वैध username, १० अंकी मोबाइल नंबर किंवा ईमेल पत्ता टाका.",
